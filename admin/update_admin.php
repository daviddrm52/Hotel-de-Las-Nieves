...
<!DOCTYPE html>
<html lang="es">
<title>Actualizar administrador - Hotel de Las Nieves</title>

<?php include('./../templates/header.php'); ?>

    <section>
    <form action="update_admin.php" method="POST" class="white">
        <?php if($User): ?>
        <fieldset>
            ...
            <div class="center">
                <button class="btn waves-effect waves-light brown darken-1" type="submit" name="submit">Actualizar administrador
