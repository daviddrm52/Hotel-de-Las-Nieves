...
<div class="container center fondoInicio">
    ...
    <div class="fondoAcerca">
        ...
        <section>
            ...
            <p class="center"> <a href="./info_reservas.php" class="waves-effect waves-light brown darken-4 btn"><i class="material-icons left">home</i> Volver a la información de reservas </a> </p>
        </section>
    </div>
