...
<?php 
    ...
    if(isset($_POST['cancel'])){
        ...
        //Creamos la query
        $queryDeleteReserva = "UPDATE 73_reservas SET estado_id = 5 WHERE id = '$id_a_actualizar'";

        //Lanzamos la query
        if(mysqli_query($conn, $queryDeleteReserva)){
            //Query de la base de datos para actualizar la habitacion cuando se haya cancelado la reserva
            $updateHabitacionReserva = "UPDATE 73_habitacio SET cerrada = '1' WHERE id = $updateAperturaHabitacion";
    ...
    $updateAperturaHabitacion = $Habitacion['id'];

?>

<!DOCTYPE html>
<html lang="es">
<title> Cancelación de la reserva - Hotel de Las Nieves </title>
...
<div class="container center white">
    ...
    <div class="container white center">
        <?php if($reserva):?>
            ...
            <?php endif; ?>
            <h5>¿Esta seguro que desea CANCELAR esta reserva?</h5>
            <form action="delete_reservas.php" method="POST">
                <input type="hidden" name="id_a_actualizar" value="<?php echo $reserva['id']?>">
                <button class="btn waves-effect waves-light brown darken-1" type="submit" name="cancel">Cancelar reserva
    ...
    <br>
        <div class="fondoAcerca">
            ...
            <section>
                ...
                <p class="center"> <a href="./select_reservas.php" class="waves-effect waves-light brown darken-4 btn"><i class="material-icons left">search</i> Volver a la busqueda de reservas </a> </p>  
            </section>
        </div>
    </br>
