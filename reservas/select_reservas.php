...
<!DOCTYPE html>
<html lang="es">
<title> Mostrando total de reservas - Hotel de Las Nieves </title>
...
<div class="center fondoInicio">
  <h5> Mostrando todas las reservas del hotel </h5>
</div>
...
<table class="highlight white">
        ...
        <tr>
          ...
          <!--<td><a href="update_reservas.php?id=<?php //echo $rev['id'] ?>">Actualizar reserva</a></td>
          <td><a href="delete_reservas.php?id=<?php //echo $rev['id'] ?>">Cancelar reserva</a></td>-->
...
<?php if(count($reservas) == 1) : ?>
    <p class="center"> <h6>Hay un total de <?php echo count($reservas)?> reserva en el hotel.</h6> </p>
<?php elseif(count($reservas) >= 2) : ?>
    <p class="center"> <h6>Hay un total de <?php echo count($reservas)?> reservas en el hotel.</h6> </p>
<?php else :?>
    <p class="center"> 
      <h6>No hay reservas en el hotel, espera a que lleguen, o crea una para probar si funciona el sistema. </h6> 
      <a href="./form_reservas.php" class="waves-effect waves-light brown darken-4 btn"><i class="material-icons left">add</i> Crear reserva de prueba </a>
    </p>
<?php endif; ?>
</div>
