...
<?php
    ...
    $sql = "SELECT * FROM 73_reservas WHERE cliente_id = '".$_SESSION["id"]."' AND estado_id = '1'";
...
<!DOCTYPE html>
<html lang="es">
<title> Seleccionar reservas - Hotel de Las Nieves </title>
...
<div class="center fondoInicio">
  <h5> Mostrando reservas activas de <?php echo $usuarios['nombre']; ?> </h5>
</div>
...
<table class="highlight white">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="./../reservas/check_in_reserva.php?id=<?php echo $rev['id'] ?>">Check in</a></td>
            <td><a href="./../reservas/check_out_reserva.php?id=<?php echo $rev['id'] ?>">Check out</a></td>
            <td><a href="./../reservas/update_reservas.php?id=<?php echo $rev['id'] ?>">Actualizar reserva</a></td>
            <td><a href="./../reservas/delete_reservas.php?id=<?php echo $rev['id'] ?>">Cancelar reserva</a></td>
            <td><a href="./../reservas/finalizar_reservas.php?id=<?php echo $rev['id'] ?>">Finalizar reserva</a></td>
...
<?php if(count($reservas) == 1) : ?>
    <p class="center"> <h6>Hay un total de <?php echo count($reservas)?> reserva confirmadas a su nombre.</h6> </p>
<?php elseif(count($reservas) >= 2) : ?>
    <p class="center"> <h6>Hay un total de <?php echo count($reservas)?> reservas confirmadas a su nombre.</h6> </p>
<?php else :?>
    <p class="center"> 
      <h6>No hay reservas confirmadas a su nombre. </h6> 
    </p>
<?php endif; ?>
</div>
