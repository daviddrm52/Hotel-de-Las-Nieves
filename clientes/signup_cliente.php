...
<?php
    ...
    $errores = array('usuario' => '', 'nombre' => '', 'apellido_primero' => '', 'apellido_segundo' => '', 'dni' => '', 'direccion' => '', 'telefono' => '', 'email' => '', 'contrasena' => '', 'fecha_nacimiento' => '')   ;
...
<!DOCTYPE html>
<html lang="es">
<title>Creando cuenta de cliente - Hotel de Las Nieves</title>

<?php include('./../templates/header.php'); ?>

    <section>
    <form action="signup_cliente.php" method="POST" class="white">
        <fieldset>
            ...
            <div class="center">
                <button class="btn waves-effect waves-light brown darken-1" type="submit" name="submit">Crear usuario
